...
//if 80 degrees above and raining wear t-shirt and take an umbrella
//If 60 - 80 degrees and raining wear a rain jacket
//if 60 degrees or below wear a rain jacket and carry an umbrella
//If not raining wear a t-shirt

if (temperature > 80 && rain === true) {
  console.log("Wear a t-shirt and carry an umbrella")
} else if (61 < temperature || temperature < 79 && rain === true){
  console.log("Wear a rain jacket")
} else if (temperature < 60 && rain === true) {
  console.log("Wear a rain jacket and carry an umbrella")
} 
...
/*
  ...
  while score is less than passing score
*/
...
if (changeMyMind === true) {
  console.log("Mind is changed to false")
  changeMyMind = false
} else { (changeMyMind === false) 
  console.log("Mind is changed to true")
  changeMyMind = true
}
